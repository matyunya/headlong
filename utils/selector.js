...
export const theme = k => k.split('.').reduce((acc, cur) => acc[cur], config.theme);

export const simpleMatch = ([className, cssProp, options, appendix]) =>
  name => {
    if (typeof options === 'function') options = options(theme, configUtils);
